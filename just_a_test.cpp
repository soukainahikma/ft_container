...
int main()
{
	...
	test.insert(ft::make_pair(50,10));
	test.insert(ft::make_pair(40,11));
	test.insert(ft::make_pair(30,12));
	// test.insert(ft::make_pair(30,12));
	// test.insert(ft::make_pair(70,12));
	// test.insert(ft::make_pair(55,12));
	// test.insert(ft::make_pair(41,12));
	// test.insert(ft::make_pair(20,12));
	// test.insert(ft::make_pair(10,12));
